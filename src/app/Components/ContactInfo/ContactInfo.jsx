            ...
            <div className="row gy-5 gx-60">
              ...
              <div className="col-xl-6">
                <div className="contact-form style1">
                  <h2 className="contact-title">Siap Memulai Project Anda?</h2>
                  <p className="desc">
                    Ceritakan kebutuhan bisnis Anda, dan tim Samta Dev akan
                    membantu mewujudkan solusi digital terbaik untuk bisnis
                    Anda.
                  </p>
                    ...
                    <div className="row g-4">
                      ...
                      >
                        <button type="submit" className="theme-btn">
                          Kirim Pesan <i className="bi bi-arrow-right"></i>
                        </button>
                      </div>
                    </div>
                  </form>
